...
const Header = () => {
  ...
  return (
    <header className="bg-gray-900 text-white py-4 px-8 w-full flex h-20 items-center justify-between ">
      ...
      <div
        className={` md:block ${
          showMenu ? "block absolute inset-0 top-20" : "hidden"
        }`}
      >
