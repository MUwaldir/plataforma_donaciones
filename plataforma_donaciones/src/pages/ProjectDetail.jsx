...
const ProjectDetail = () => {
    ...
    const project = {
        ...
        description: 'Ayúdanos a construir nuevas escuelas para niños en comunidades desfavorecidas.',
        goal: 5000,
    ...
    return (
        <div className="container mx-auto py-8">
            ...
            <div className="flex justify-around mt-4 " style={{marginBottom:'50px'}}>
                {project.images.map((imageUrl, index) => (
                    <img key={index} src={imageUrl} alt={`Imagen ${index + 1}`} className="w-1/3 m-1 rounded-md " />
                ))}
            </div>
        </div>
    );
