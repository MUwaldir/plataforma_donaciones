...
const lessons = [
    {
        ...
        "content": {
          "introduction": "¡Bienvenido a esta sesión introductoria sobre álgebra! En esta lección, exploraremos los conceptos básicos del álgebra y su importancia en las matemáticas y otras disciplinas.",
          "definition": {
            "title": "Definición de Álgebra",
            "description": "El álgebra es una rama de las matemáticas que estudia las relaciones y las operaciones aritméticas utilizando variables y símbolos en lugar de números concretos."
          },
          "variablesAndConstants": {
            "title": "Variables y Constantes",
            "description": "En álgebra, las letras se utilizan para representar cantidades desconocidas o variables. Las constantes son valores fijos que no cambian, como los números concretos."
          },
          "algebraicExpressions": {
            "title": "Expresiones Algebraicas",
            "description": "Una expresión algebraica es una combinación de variables, constantes y operadores matemáticos."
          },
          "equationsAndInequalities": {
            "title": "Ecuaciones y Desigualdades",
            "description": "Una ecuación algebraica es una expresión que establece una igualdad entre dos expresiones algebraicas. Las desigualdades algebraicas establecen una relación de orden entre dos expresiones algebraicas."
          }
        },
        "images": [
          {
...
,      
{
    ...
    "images": [
      {
        "url": "https://media.gcflearnfree.org/content/5d289a0017bf4859ec68b350_07_12_2019/Expresiones%20algebraicas.png",
        "description": "Descripción de la imagen 1 ... Descripción de la imagen 1 Descripción de la imagen 1 Descripción de la imagen 1 Descripción de la imagen 1"
      },
      {
        "url": "https://media.gcflearnfree.org/content/5d289a0017bf4859ec68b350_07_12_2019/Expresiones%20algebraicas.png",
        "description": "Descripción de la imagen 2"
    ...
    {videoId && (
         <div className=" aspect-w-16 aspect-h-9 flex justify-center mt-4 ">
           <YouTube
             ...
             opts={opts}
             onReady={_onReady}
             className=" inset-0 w-full h-full md:w-1/2"
           />
         </div>
       )}

{nextLessonUrl && (
        <Link to={nextLessonUrl} className="bg-blue-500 text-white px-4 py-2 rounded-md mt-4">
          Siguiente Lección
        </Link>
      )}
  </div>
